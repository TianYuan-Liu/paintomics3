	...
	this.initComponent = function() {
		...
		this.component = Ext.create('Ext.container.Viewport', {
			...
			items: [{
				...
				"     <li class='menuOption externalOption' style='font-size: 9px;'><a href='https://doi.org/10.1093/nar/gky466' target='_blank'>Hernández-de-Diego R, Tarazona S, Martínez-Mira C, Balzano-Nogueira L, Furió-Tarí P, Pappas J G, Conesa A. <b>PaintOmics 3: a web resource for the pathway analysis and visualization of multi-omics data</b>. <i>Nucleic Acids Research</i> 2018).</a><br><a href='resources/images/paintomics3.bib' target='_blank'>BibTeX</a></li>" +
				" </ul></li>" +
